...
<fieldset  style="width:300px"><ol>
     ...
     <li>  <?php echo $na[3];?><input type="radio" name="scode1" required value="<?php echo $ta4; ?>"/><br></br></li>
       ...
       <li><?php echo $na[5];?><input type="radio" name="scode1" required value="<?php echo $ta6; ?>"/><br></br></li>
        </ol>
</fieldset>
...
<br><h4>Select one of subject from <i>Group <?php echo $type1;?></i>  </h4> <br></br> <fieldset style="width:350px" ><ol>
     ...
     <li>  <?php echo $nb[3];?><input type="radio" name="scode2" required value="<?php echo $tb4; ?>"/><br></br></li>
       ...
       <li><?php echo $nb[5];?><input type="radio" name="scode2" required value="<?php echo $tb6; ?>"/><br></br></li>
        </ol>
</fieldset>
