...
echo "<br></br>".$usn."<>";
     ...
     if($numrows==8){//to check wether there are actual number of subject entered in syllabus table 4th sem has 8 subject
        ...
        $sql5 = "INSERT INTO register(`USN`, `Code`) VALUES ('".$usn."' ,'".$t[4]."' )";
        $result5=mysql_query($sql5);

        $sql6 = "INSERT INTO register(`USN`, `Code`) VALUES ('".$usn."' ,'".$t[5]."' )";
        $result6=mysql_query($sql6);

         $sql7 = "INSERT INTO register(`USN`, `Code`) VALUES ('".$usn."' ,'".$t[6]."' )";
        $result7=mysql_query($sql7);

         $sql8 = "INSERT INTO register(`USN`, `Code`) VALUES ('".$usn."' ,'".$t[7]."' )";
        	...
        	{ 
            	//$scode= $row[S_Code];
     			//echo $scode;
     			 ...
     			 echo "<br><li> <b>Subject Code :".$row[Code]."</li></b>";
