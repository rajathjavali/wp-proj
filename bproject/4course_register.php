...
//echo "<br></br>".$usn."<>";
     ...
     //to check wether there are actual number of subject entered in syllabus table 4th sem has 8 subject
        ...
        $sql7 = "INSERT INTO studcourse(`USN`, `ccode`'sem','acy') VALUES ('".$usn."' ,'".$t[4]."','".$sem"','".$acy"' )";
