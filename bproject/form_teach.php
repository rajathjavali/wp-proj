...
<form class="form-horizontal" id="demo-form" data-parsley-validate method="post" action="teach_register.php">
  <fieldset>
  ...
  <!-- USN:  <input type="text" name="usn" required value="<?php// echo $usn;?>"> -->
      ...
      <div class="col-lg-10">
        <input type="text" class="form-control" id="staffid" placeholder="unique initials" name="staffid" readonly required value="<?php echo $staffid;?>" style="width: 210px;">
      </div>
    </div>
